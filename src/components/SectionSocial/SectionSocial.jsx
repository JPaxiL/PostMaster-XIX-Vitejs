...
const SectionSocial = () => {
  return (
    <section className="section-sociales">
      ...
      >
        <img className="icon__img" src={iconFacebook} alt="icon-facebook" />
      </a>
      <a className="icon" target="_blank" href="https://twitter.com/">
        <img className="icon__img" src={iconTwitter} alt="iconTwitter" />
      </a>
      <a className="icon" target="_blank" href="https://www.linkedin.com/feed/">
        <img className="icon__img" src={iconLinkedin} alt="icon-linkedin" />
      </a>
      <a className="icon" target="_blank" href="https://www.instagram.com/">
        <img className="icon__img" src={iconInstagram} alt="icon-instagram" />
      </a>
    </section>
  );
};
